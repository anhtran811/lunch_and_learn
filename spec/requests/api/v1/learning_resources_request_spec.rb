...
describe 'GET /learning_resources' do
  context 'when the videos and photos return data' do
    it "can return the country's learning resources" do
      country = "thailand"
...
require 'pry'; binding.pry
      ...
      expect(resources_response[:data]).to be_an(Array)
      ...
      expect(resources_response[:data][:type]).to eq("learning_resource") 
